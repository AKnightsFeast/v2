    ...
    return (
        <>
            ...
            <div className="menu">
                ...
                <div>         
                    <ul>
                        <li>Healthy Baked Chicken Tenders (Marinated in Dijon and Yogurt and Coated in Whole Wheat Bread Crumbs) with Green beans or Broccoli</li>
                        <li>Healthy Baked Haddock Fish Sticks with Greek Yogurt Tarter Sauce with Green Beans or Broccoli</li>
                    </ul>
                </div>
            </div>
            <div className="menu">
            ...
            <div className="menu">
                ...
                <div className="summary">
                    <div>
                        Chilies are served one of three ways with sour cream and green onions on the side (please indicate if 
                        you like beans or no beans and heat level): Casserole style with Corn Bread and Cheese Baked on top, 
                        Casserole Style with Macaroni or rice on the bottom with cheese on top, or Separate
                    </div>
                </div>
                <div>
                    <ul>
            ...
            <div className="menu">
                ...
                <div>
                    <ul>
                        <li>
                            <div className="sub-header">Spring/Summer</div>
                            <ul>
                        ...
                        <li>
                            <div className="sub-header">Fall/Winter</div>
                            <ul>
                                <li>Apple Cobbler</li>
                                <li>Pear Cobbler</li>
