    ...
    return (
        <div className="assessment">
            ...
            <div className={`${stepIdx === totalSteps ? "hidden" : ""}`}>
                ...
                <div className="py-10">	
                    <form>
                        <div className={`step${stepOrder[stepIdx] === "contact" ? " active" : ""}`}>
                            <Contact person={contact} contactInfoOptional={false} onContactUpdate={ onUpdateContact } />
                        </div>



                        <div className={`step${stepOrder[stepIdx] === "address" ? " active" : ""}`}>
                        ...
                        <div className={`step${stepOrder[stepIdx] === "people" ? " active" : ""}`}>
                            <div>
